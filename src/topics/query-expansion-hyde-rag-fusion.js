      ...
      paragraphs: [
        {
          type: 'bullets',
          items: [
            'Naive single query: 0 expansion LLM calls, 1 retrieval call, baseline recall, and vocabulary mismatch as the main risk.',
            'Query rewriting: 1 LLM call, usually 2-4 retrieval calls, moderate recall gain, and query drift as the main risk.',
            'HyDE: 1 LLM call, usually 1-2 retrieval calls, strong paraphrase recall, and hallucinated routing as the main risk.',
            'RAG-Fusion: 1 LLM call, usually 3-5 retrieval calls, high recall, and a latency plus noise ceiling as the main risk.',
            'Multi-query plus HyDE plus fusion: 2 LLM calls, 4-8 retrieval calls, the highest recall potential, and diminishing returns after the first few views.',
          ],
        },
      ...
      paragraphs: [
        {
          type: 'bullets',
          items: [
            'Gao et al., 2023: HyDE uses hypothetical document embeddings for zero-shot dense retrieval; ACL 2023, https://arxiv.org/abs/2212.10496.',
            'Rackauckas, 2023: RAG-Fusion combines multi-query retrieval with reciprocal rank fusion; https://arxiv.org/abs/2402.03367.',
            'Rocchio, 1971: pseudo-relevance feedback is the original query expansion idea; The SMART Retrieval System, chapter 14.',
            'Cormack et al., 2009: Reciprocal Rank Fusion gives the rank aggregation formula used by many fusion systems; SIGIR 2009.',
          ],
        },
