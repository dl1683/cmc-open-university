  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        {type: 'image', src: './assets/gifs/loss-landscapes.gif', alt: 'Animated walkthrough of the loss landscapes visualization', caption: 'Animation preview: the full visualization plays through each step at reading pace.'},],
    },
    {
