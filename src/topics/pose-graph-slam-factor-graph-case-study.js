  ...
  sections: [
    {
      ...
      paragraphs: [
        'Read each pose node as an unknown robot position and orientation. A factor is a measurement that says how one pose should relate to another pose, using sensor evidence and a noise weight.',
        'In the loop-closure view, the long edge is evidence that the robot has returned near an earlier place. The optimized path changes many poses because the solver must satisfy loop evidence and odometry evidence together.',
        {type:'callout', text:`Pose graph SLAM treats the trajectory as an optimizable evidence graph, so new loop evidence can redistribute drift instead of patching one pose.`},
        {type:'image', src:'https://upload.wikimedia.org/wikipedia/commons/a/ad/RoboCup_Rescue_arena_map_generated_by_robot_Hector_from_Darmstadt_at_2010_German_open.jpg', alt:'Laptop display showing an arena map generated by a rescue robot during a RoboCup event.', caption:`Arena map generated by the Darmstadt Rescue Robot Team at the 2010 RoboCup German Open. Photo by Mike1024, public domain, via Wikimedia Commons.`},
      ],
    },
    {
      heading: 'Why this exists',
      paragraphs: [
        'SLAM means simultaneous localization and mapping: a robot estimates its own path while building or maintaining a map. Pose-graph SLAM exists because dead reckoning accumulates drift from wheel slip, inertial noise, visual ambiguity, and scan-matching error.',
      ],
    },
    {
      heading: 'The obvious approach',
      paragraphs: [
        'The obvious approach is to append poses one at a time. Start at x0, apply the measured motion to get x1, then keep chaining odometry as the robot moves.',
      ],
    },
    {
      heading: 'The wall',
      paragraphs: [
        'The wall is accumulated drift. A one-degree heading error early in a hallway can become meters of position error after a long route.',
      ],
    },
    {
      heading: 'The core insight',
      paragraphs: [
        'Store the trajectory as variables and the measurements as constraints. Odometry, scan matches, GPS, priors, landmarks, and loop closures become factors attached to shared pose variables.',
      ],
    },
    {
      heading: 'How it works',
      paragraphs: [
        'The solver computes residuals, which are differences between measured relationships and relationships predicted by the current poses. It linearizes those residuals, solves a sparse least-squares problem, applies pose updates, and repeats.',
      ],
    },
    {
      heading: 'Why it works',
      paragraphs: [
        'The correctness claim is an estimation claim, not a sorting-style proof. If factors describe the measurements honestly and the noise model is reasonable, minimizing weighted squared residuals gives the maximum-likelihood estimate under Gaussian noise assumptions.',
      ],
    },
    {
      heading: 'Cost and complexity',
      paragraphs: [
        'Cost grows with poses, factors, graph connectivity, relinearization frequency, and fill-in during sparse factorization. A chain of 1,000 odometry factors is much cheaper than a graph with many distant loop closures and landmarks.',
      ],
    },
    {
      heading: 'Real-world uses',
      paragraphs: [
        'Pose graphs are used in mobile robots, warehouse autonomy, drones, autonomous vehicles, visual-inertial odometry, lidar mapping backpacks, and augmented-reality systems. They fit systems that collect many relative measurements and occasional revisits.',
      ],
    },
    {
      heading: 'Where it fails',
      paragraphs: [
        'It fails when data association is wrong. Repeated corridors, similar shelves, dynamic objects, and feature-poor spaces can create false or weak loop closures.',
      ],
    },
    {
      heading: 'Worked example',
      paragraphs: [
        'A robot drives a square with four 10 meter sides. Odometry says the final pose is 1.2 meters east and 0.4 meters north of the start with a 5 degree heading error, and a scan matcher adds a loop closure that pulls correction across the whole graph.',
      ],
    },
    {
      heading: 'Sources and study next',
      paragraphs: [
        'Useful references include the GTSAM factor graph tutorial, PoseSLAM material, g2o papers, and modern visual-inertial SLAM systems. Study Factor Graphs, Nonlinear Least Squares, Sparse Matrix Factorization, Robust Kernels, ICP, Visual Place Recognition, Occupancy Grids, Kalman Filtering, and RRT* Motion Planning next.',
      ],
    },
  ],
};
